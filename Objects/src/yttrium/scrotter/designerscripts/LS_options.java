...
//BA.debugLineNum = 7;BA.debugLine="StretchCheckbox.Width = 46%x"[options/General script]
views.get("stretchcheckbox").setWidth((int)((46d / 100 * width)));
//BA.debugLineNum = 8;BA.debugLine="GlossCheckbox.Width = 46%x"[options/General script]
views.get("glosscheckbox").setWidth((int)((46d / 100 * width)));
//BA.debugLineNum = 9;BA.debugLine="ShadowCheckbox.Width = 46%x"[options/General script]
views.get("shadowcheckbox").setWidth((int)((46d / 100 * width)));
//BA.debugLineNum = 10;BA.debugLine="UnderShadowCheckbox.Width = 46%x"[options/General script]
views.get("undershadowcheckbox").setWidth((int)((46d / 100 * width)));
...
//BA.debugLineNum = 13;BA.debugLine="GlossCheckbox.Left = 50%x"[options/General script]
views.get("glosscheckbox").setLeft((int)((50d / 100 * width)));
//BA.debugLineNum = 14;BA.debugLine="UnderShadowCheckbox.Left = 50%x"[options/General script]
views.get("undershadowcheckbox").setLeft((int)((50d / 100 * width)));
