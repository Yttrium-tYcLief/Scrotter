...
//BA.debugLineNum = 7;BA.debugLine="GlossCheckbox.Width = 100%x - 8%x"[options/General script]
views.get("glosscheckbox").setWidth((int)((100d / 100 * width)-(8d / 100 * width)));
//BA.debugLineNum = 8;BA.debugLine="ShadowCheckbox.Width = 100%x - 8%x"[options/General script]
views.get("shadowcheckbox").setWidth((int)((100d / 100 * width)-(8d / 100 * width)));
//BA.debugLineNum = 9;BA.debugLine="UnderShadowCheckbox.Width =100%x - 8%x"[options/General script]
views.get("undershadowcheckbox").setWidth((int)((100d / 100 * width)-(8d / 100 * width)));
//BA.debugLineNum = 10;BA.debugLine="ShadowCheckbox.Left = 4%x"[options/General script]
views.get("shadowcheckbox").setLeft((int)((4d / 100 * width)));
//BA.debugLineNum = 11;BA.debugLine="GlossCheckbox.Left = 4%x"[options/General script]
views.get("glosscheckbox").setLeft((int)((4d / 100 * width)));
//BA.debugLineNum = 12;BA.debugLine="UnderShadowCheckbox.Left = 4%x"[options/General script]
views.get("undershadowcheckbox").setLeft((int)((4d / 100 * width)));
//BA.debugLineNum = 13;BA.debugLine="UnderShadowCheckbox.Bottom = 100%y- 4%x"[options/General script]
views.get("undershadowcheckbox").setTop((int)((100d / 100 * height)-(4d / 100 * width) - (views.get("undershadowcheckbox").getHeight())));
//BA.debugLineNum = 14;BA.debugLine="ShadowCheckbox.Bottom = UnderShadowCheckbox.Top"[options/General script]
views.get("shadowcheckbox").setTop((int)((views.get("undershadowcheckbox").getTop()) - (views.get("shadowcheckbox").getHeight())));
//BA.debugLineNum = 15;BA.debugLine="GlossCheckbox.Bottom = ShadowCheckbox.Top"[options/General script]
views.get("glosscheckbox").setTop((int)((views.get("shadowcheckbox").getTop()) - (views.get("glosscheckbox").getHeight())));
//BA.debugLineNum = 16;BA.debugLine="Loading.Bottom = GlossCheckbox.Top"[options/General script]
views.get("loading").setTop((int)((views.get("glosscheckbox").getTop()) - (views.get("loading").getHeight())));
//BA.debugLineNum = 17;BA.debugLine="Loading.Top = VariantBox.Bottom - ((VariantBox.Bottom - Loading.Top) / 2)"[options/General script]
...
//BA.debugLineNum = 18;BA.debugLine="Loading.Left = (100%x - Loading.Width) / 2"[options/General script]
